...
fn main() -> ! {
    ...
    let _timer = rp_pico::hal::Timer::new(pac.TIMER, &mut pac.RESETS, &clocks);
    let timer_freq_hz = 1_000_000; // RP2040 timer runs at 1 MHz

    rprintln!("Platform: RP2040 (Cortex-M0+ without FPU)");
